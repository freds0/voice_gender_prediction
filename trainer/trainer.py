...
class Trainer():
    ...
    def train(self):
        ...
        for epoch in range(self.start_epoch, self.epochs + 1):
            ...
            self.logger.info("\tTrain Loss: {:.6f} Accuracy: {:.4f} Recall: {:.4f}".format(train_metrics['loss'], train_metrics['accuracy'], train_metrics['recall']))
            self.logger.info("\tVal   Loss: {:.6f} Accuracy: {:.4f} Recall: {:.4f}".format(val_metrics['loss'], val_metrics['accuracy'], val_metrics['recall']))

            # save tensorboard informations
            self.writer.add_scalar("Loss/train", train_metrics['loss'], epoch)
            self.writer.add_scalar("accuracy/train", train_metrics['accuracy'], epoch)
            self.writer.add_scalar("f1_score/train", train_metrics['f1_score'], epoch)
            ...
            self.writer.add_scalar("f1_score/val", val_metrics['f1_score'], epoch)
